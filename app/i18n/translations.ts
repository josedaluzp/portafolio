  ...
  es: {
    ...
    projects: {
      ...
      items: {
        ...
        'tracker-servicios': { title: 'Tracker de Servicios', pitch: 'Clientes que no recibían actualizaciones sobre el estado de sus servicios. Ahora reciben notificaciones automáticas por SMS y llamadas en cada etapa.' },
  ...
  en: {
    ...
    projects: {
      ...
      items: {
        ...
        'tracker-servicios': { title: 'Service Tracker', pitch: 'Clients who received no updates on their service status. Now they get automatic notifications via SMS and calls at every stage.' },
