  ...
  es: {
    ...
    projects: {
      ...
      items: {
        ...
        'tracker-servicios': { title: 'Tracker de Servicios', pitch: 'Gestión de servicios y gastos desde WhatsApp. Un agente de IA interpreta comandos en lenguaje natural, actualiza precios, registra gastos y consulta totales — todo sincronizado en tiempo real con Google Sheets.' },
  ...
  en: {
    ...
    projects: {
      ...
      items: {
        ...
        'tracker-servicios': { title: 'Service Tracker', pitch: 'Service and expense management via WhatsApp. An AI agent interprets natural language commands, updates pricing, logs expenses, and queries totals — all synced in real time with Google Sheets.' },
