...
const SOCIAL_LINKS = [
  {
    label: "GitHub",
    href: "https://github.com/josedaluzp",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/josedaluzpereira/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
  ...
  {
    label: "Email",
    href: "mailto:josedaluzpereira1509@gmail.com",
    icon: (
  ...
  {
    label: "WhatsApp",
    href: "https://wa.me/5493517561122",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
